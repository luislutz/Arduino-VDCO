...
Oscil <SQUARE_NO_ALIAS512_NUM_CELLS, AUDIO_RATE> aSqu6(SQUARE_NO_ALIAS512_DATA);
Oscil <SQUARE_NO_ALIAS512_NUM_CELLS, AUDIO_RATE> aSqu7(SQUARE_NO_ALIAS512_DATA);
...
Oscil <TRIANGLE512_NUM_CELLS, AUDIO_RATE> aTri6(TRIANGLE512_DATA);
Oscil <TRIANGLE512_NUM_CELLS, AUDIO_RATE> aTri7(TRIANGLE512_DATA);
...
#define CONTROL_RATE 128 // Hz, owers of 2 are most reliable
...
const static byte gain_table[7][256]PROGMEM = {
...
const static byte harm_table[6][256]PROGMEM = {
...
void setFreqs(Q16n16 freq) {
 carrier_freq = freq ; 
 mod_freq = ((carrier_freq >> 8)  * (AnalogRead1 / 2 +AnalogRead4 / 2));

 if ((AnalogRead1 < 1020) && (abs(AnalogRead3 - AnalogSave1) > 3)) {

   AnalogSave2 = AnalogRead3;
  
   deviation = ((mod_freq >> 16) * (1 + AnalogRead3 + AnalogRead5));
  ...
  switch (wave0) {
    ...
    case 0:
        aSin1.setFreq_Q16n16(carrier_freq);
        aSin2.setFreq_Q16n16(mod_freq);
        break;
    case 1:
        aTri1.setFreq_Q16n16(carrier_freq);
        aTri2.setFreq_Q16n16(mod_freq);
        break;
    case 2:
        aSaw1.setFreq_Q16n16(carrier_freq);
        aSaw2.setFreq_Q16n16(mod_freq);
        break;
    case 3:
        aSqu1.setFreq_Q16n16(carrier_freq);
        aSqu2.setFreq_Q16n16(mod_freq);
        break;
    case 4:
        aChb1.setFreq_Q16n16(carrier_freq);
        aChb2.setFreq_Q16n16(mod_freq);
        break;
    case 5:
        ahSin1.setFreq_Q16n16(carrier_freq);
        ahSin2.setFreq_Q16n16(mod_freq);
        break;
    case 6:
        aSig1.setFreq_Q16n16(carrier_freq);
        aSig2.setFreq_Q16n16(mod_freq);
        break;
    case 7:
        aPha1.setFreq_Q16n16(carrier_freq);
        aPha2.setFreq_Q16n16(mod_freq);
        break;
...
if (Mode == 2) {
  ...
  if ((AnalogRead1 >= 1020) && (abs(AnalogRead3 - AnalogSave2) > 3))  {
    wave2 = (AnalogRead3 / 256);
    AnalogSave1 = AnalogRead3;
  }
...
switch (wave2) {
  ...
  case 1: 
     ...
     aTri2.setFreq(freqv1 * (pgm_read_byte(&(harm_table[0][harm_knob])))); 
     aTri3.setFreq(freqv1 * (pgm_read_byte(&(harm_table[1][harm_knob])))); 
     aTri4.setFreq(freqv1 * (pgm_read_byte(&(harm_table[2][harm_knob])))); 
     aTri5.setFreq(freqv1 * (pgm_read_byte(&(harm_table[3][harm_knob])))); 
     aTri6.setFreq(freqv1 * (pgm_read_byte(&(harm_table[4][harm_knob])))); 
     aTri7.setFreq(freqv1 * (pgm_read_byte(&(harm_table[5][harm_knob])))); 
     break;
  case 2: 
     aSqu1.setFreq(freqv1); // set the frequency
     aSqu2.setFreq(freqv1 * (pgm_read_byte(&(harm_table[0][harm_knob])))); 
     aSqu3.setFreq(freqv1 * (pgm_read_byte(&(harm_table[1][harm_knob])))); 
     aSqu4.setFreq(freqv1 * (pgm_read_byte(&(harm_table[2][harm_knob])))); 
     aSqu5.setFreq(freqv1 * (pgm_read_byte(&(harm_table[3][harm_knob])))); 
     aSqu6.setFreq(freqv1 * (pgm_read_byte(&(harm_table[4][harm_knob])))); 
     aSqu7.setFreq(freqv1 * (pgm_read_byte(&(harm_table[5][harm_knob])))); 
     break;
  case 3: 
     
     aSaw1.setFreq(freqv1); // set the frequency
     aSaw2.setFreq(freqv1 * (pgm_read_byte(&(harm_table[0][harm_knob])))); 
     aSaw3.setFreq(freqv1 * (pgm_read_byte(&(harm_table[1][harm_knob])))); 
     aSaw4.setFreq(freqv1 * (pgm_read_byte(&(harm_table[2][harm_knob])))); 
     aSaw5.setFreq(freqv1 * (pgm_read_byte(&(harm_table[3][harm_knob])))); 
     aSaw6.setFreq(freqv1 * (pgm_read_byte(&(harm_table[4][harm_knob])))); 
     aSaw7.setFreq(freqv1 * (pgm_read_byte(&(harm_table[5][harm_knob])))); 
     break;
...
//chord setting
 ...
 if ((inv_knob < 1020) && (abs(AnalogRead3 - AnalogSave1) > 3)) { //when selecting wave , not apply
   AnalogSave2 = AnalogRead3;
   switch (inv) {
     case 0:
       inv_aply1 = 0;
 ...
 //set wave
 if ((inv_knob >= 1020) && (abs(AnalogRead3 - AnalogSave2) > 3)) {
   wave1 = (AnalogRead3 / 128);
   AnalogSave1= AnalogRead3;
 }
...
if (Mode == 2) {
  ...
  switch (wave2) {
    case 0:
      ...
      break;
    case 1:
      return MonoOutput::from8Bit((aTri1.next()  * (pgm_read_byte(&(gain_table[0][gain]))) / 512  + aTri2.next() * (pgm_read_byte(&(gain_table[1][gain]))) / 512 + aTri3.next() * (pgm_read_byte(&(gain_table[2][gain]))) / 512 + aTri4.next() * (pgm_read_byte(&(gain_table[3][gain]))) / 512 + aTri5.next() * (pgm_read_byte(&(gain_table[4][gain]))) / 512 + aTri6.next() * (pgm_read_byte(&(gain_table[5][gain]))) / 512 + aTri7.next() * (pgm_read_byte(&(gain_table[6][gain]))) / 512 )*Gain_CV_2/128);
      break;
    case 2:
      return MonoOutput::from8Bit((aSqu1.next()  * (pgm_read_byte(&(gain_table[0][gain]))) / 512  + aSqu2.next() * (pgm_read_byte(&(gain_table[1][gain]))) / 512 + aSqu3.next() * (pgm_read_byte(&(gain_table[2][gain]))) / 512 + aSqu4.next() * (pgm_read_byte(&(gain_table[3][gain]))) / 512 + aSqu5.next() * (pgm_read_byte(&(gain_table[4][gain]))) / 512 + aSqu6.next() * (pgm_read_byte(&(gain_table[5][gain]))) / 512 + aSqu7.next() * (pgm_read_byte(&(gain_table[6][gain]))) / 512 )*Gain_CV_2/128);
      break;
    case 3:
      return MonoOutput::from8Bit((aSaw1.next()  * (pgm_read_byte(&(gain_table[0][gain]))) / 512  + aSaw2.next() * (pgm_read_byte(&(gain_table[1][gain]))) / 512 + aSaw3.next() * (pgm_read_byte(&(gain_table[2][gain]))) / 512 + aSaw4.next() * (pgm_read_byte(&(gain_table[3][gain]))) / 512 + aSaw5.next() * (pgm_read_byte(&(gain_table[4][gain]))) / 512 + aSaw6.next() * (pgm_read_byte(&(gain_table[5][gain]))) / 512 + aSaw7.next() * (pgm_read_byte(&(gain_table[6][gain]))) / 512 )*Gain_CV_2/128);
      break; 
  ...
  switch (wave0) {
    case 0:
      modulation = deviation * aSin2.next() >> 8;
      return MonoOutput::from8Bit(aSin1.phMod(modulation)*Gain_CV_1/256);
      break;
    case 1:
      modulation = deviation * aTri2.next() >> 8;
      return MonoOutput::from8Bit(aTri1.phMod(modulation)*Gain_CV_1/256);
      break;
    case 2:
      modulation = deviation * aSaw2.next() >> 8;
      return MonoOutput::from8Bit(aSaw1.phMod(modulation)*Gain_CV_1/256);
      break;
    case 3:
      modulation = deviation * aSqu2.next() >> 8;
      return MonoOutput::from8Bit(aSqu1.phMod(modulation)*Gain_CV_1/256);
      break;
    case 4:
      modulation = deviation * aChb2.next() >> 8;
      return MonoOutput::from8Bit(aChb1.phMod(modulation)*Gain_CV_1/256);
      break;
    case 5:
      modulation = deviation * ahSin2.next() >> 8;
      return MonoOutput::from8Bit(ahSin1.phMod(modulation)*Gain_CV_1/256);
      break;
    case 6:
      modulation = deviation * aSig2.next() >> 8;
      return MonoOutput::from8Bit(aSig1.phMod(modulation)*Gain_CV_1/256);
      break;
    case 7:
      modulation = deviation * aPha2.next() >> 8;
      return MonoOutput::from8Bit(aPha1.phMod(modulation)*Gain_CV_1/256);
      break;
 }
